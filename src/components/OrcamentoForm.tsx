        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          >
            <div>
              ...
              <h1
                className="text-white text-[clamp(36px,5vw,56px)] leading-[0.92] mb-6 whitespace-pre-line"
          ...
          {status === "success" ? (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <label className={labelClass} style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>{o.labels.name} *</label>
                  <input
                    type="text"
                    required
                    placeholder={o.placeholders.name}
                    value={form.name}
                ...
                <div>
                  <label className={labelClass} style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>{o.labels.email} *</label>
                  <input
                    type="email"
                    required
                    placeholder={o.placeholders.email}
                    value={form.email}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
                <div>
                  <label className={labelClass} style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>{o.labels.phone}</label>
                  <input
                    type="tel"
                    placeholder={o.placeholders.phone}
                    value={form.phone}
                ...
                <div className="flex flex-col justify-between" style={{ minHeight: "80px" }}>
                  <label className={labelClass} style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>{o.labels.projectType}</label>
                  <div className="flex flex-wrap gap-2">
                    {o.projectTypes.map((t) => (
                      <button
                        key={t}
                        type="button"
              ...
              <div>
                <label className={labelClass} style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>{o.labels.budget}</label>
              ...
              <div>
                <label className={labelClass} style={{ fontFamily: "'Clash Grotesk', sans-serif" }}>{o.labels.message} *</label>
                <textarea
                  required
                  rows={5}
                  placeholder={o.placeholders.message}
                  value={form.message}
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <button
                  ...
                  style={{ fontFamily: "'Clash Grotesk', sans-serif", fontWeight: 600 }}
                >
                  {status === "loading" ? o.submitting : o.submitBtn}
                </button>
              </div>
            </motion.form>
          )}
